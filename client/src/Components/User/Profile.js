    ...
    <Dialog open={profile.open} onClose={handleClose}>
      ...
      <form onSubmit={handleSubmit}>
        <DialogContent dividers>
          ...
          <TextField autoFocus margin="normal" variant="standard" id="name" label="Name" type="text" fullWidth inputRef={nameRef} inputProps={{ minLength: 2 }} required defaultValue={currentUser?.name} />
